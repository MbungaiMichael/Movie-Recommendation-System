...
## Results
The distribution of the data after being clustered can be seen here in order of size![Cluster Distribution](https://github.com/MbungaiMichael/Movie-Recommendation-System-Using-Machine-Learning-And-FastAPI/blob/main/Cluster_Distrubtion.png)
